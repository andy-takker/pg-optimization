...
4. **Prometheus/VM «всё лгут» между точками** (lookback до 5 мин, step ≥ scrape-интервала) — к графикам относиться критически, для точности на больших окнах брать оконные функции.
